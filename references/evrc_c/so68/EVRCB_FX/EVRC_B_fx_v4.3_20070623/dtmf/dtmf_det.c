...
/*===========================================================================*/
/*         ..DTMF Detector (called every N samples)                          */
/*---------------------------------------------------------------------------*/
short  DtmfDetector (      /* (o) - 1 = possible DTMF in N sample frame, */
                           /*       0 = no DTMF  */
    DTMF_DETECTOR* D,      /* (i) - pointer to detector structure */
    short*         data,   /* (i) - input data buffer */
    long           Lframe  /* (i) - current frame number */
)
{
    /* ..(local) variables..*/
