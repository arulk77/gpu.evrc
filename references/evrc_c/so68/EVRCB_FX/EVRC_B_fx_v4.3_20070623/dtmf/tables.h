...
#define N                 80    /* Goertzel filter block size */

#define THR_DURATION       3    /* Number of consecutive blocks of size N */
                                /* that must pass all validity checks */
                                /* before a "valid DTMF" is declared */

#define THR_SIG1        6226    /* threshold for possible tone */
#define THR_PAU         1501    /* threshold for pause energy */
#define THR_STDTWI      8231    /* threshold for standard twist (-6dB) */
#define THR_REVTWI      3276    /* threshold for reverse twist (-10dB) */
#define THR_ROWREL      6554    /* threshold for row's relative peak ratio */
#define THR_ROW2nd     29492    /* threshold for row's 2nd harmonic ratio */
#define THR_COLREL      6554    /* threshold for col's relative peak ratio */
#define THR_COL2nd      6554    /* threshold for col's 2nd harmonic ratio */
#define DTMF_GAIN      8192     /*  volume of generated tone     */

#define THR_ROW160     19660    /* threshold for row's 160 pt ratio */

extern  short  thr_rowrel[4];
extern  short  thr_sig2[4];
extern  short  COEF1st[8];      /* 1st Harmonic Goertzel coefficients */
extern  short  COEF2nd[8];      /* 2nd Harmonic Goertzel coefficients */
extern  short  dtmf_lookup_table[16];
extern  short  dtmf_low_freq[13];
extern  short  dtmf_high_freq[13];
