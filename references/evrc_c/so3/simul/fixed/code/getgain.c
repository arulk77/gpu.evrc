...
void getgain(short *exctation, short *lambda, short *H, short *idxcb, short *gcb, short *gcb_mid, short gcb_size, short Quantize, short *mresidual, short subframel, short hlength)
{
	...
	for (i = 0; i < subframel; i++)
		exctation[i] = round(L_shl(L_mult(*lambda, exctation[i]), 1));
}
