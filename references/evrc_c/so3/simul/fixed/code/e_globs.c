...
/*         ..Globals (encoder).                                         */
/*----------------------------------------------------------------------*/
short *ExconvH = Scratch;		/* Excitation of adaptive codebook convolved with H (uses Scratch) */

long encode_fcnt;				/* Frame counter */

short HPspeech[FrameSize+GUARD*2];	/* orig. speech signal  */
...
short TARGETw[SubFrameSize + 1];	/* weighted target */
...
short *worigm = origm;			/* shared weighted original memory */
